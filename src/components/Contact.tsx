  ...
  return (
    <section id="contact" className="bg-portfolio-navy">
      <div className="section-container text-center max-w-2xl mx-auto">
        <p className="text-portfolio-teal mb-2">03. What's Next?</p>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">Get In Touch</h2>
        
        <p className="mb-12 text-portfolio-slate">
        ...
        <div className="mt-24 flex justify-center space-x-8">
          <a href="#" className="text-portfolio-light-slate hover:text-portfolio-teal">
